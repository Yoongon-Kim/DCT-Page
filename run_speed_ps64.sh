...
if [[ "$RUN_DEFAULT" == "1" ]]; then
  echo ""
  echo "============================================================"
  echo "DCT DEFAULT: ps64 / topk32 / comp2 / Haar / drop"
  echo "============================================================"
  run_python speed_test_dummy.py \
    "${COMMON_ARGS[@]}" \
    --mode dct \
    ...
    --run_name ps64_topk32_comp2_haar_drop_w${WARMUP_STEPS}_r${NUM_REPEATS}_m${MAX_NEW_TOKENS}
fi

if [[ "$RUN_COMP4" == "1" ]]; then
  echo ""
  echo "============================================================"
  echo "DCT CANDIDATE: ps64 / topk32 / comp4 / Haar / drop"
  echo "============================================================"
  run_python speed_test_dummy.py \
    "${COMMON_ARGS[@]}" \
    --mode dct \
    ...
    --group_agg_method mean \
    --unselected_mode drop \
    --run_name ps64_topk32_comp4_haar_drop_w${WARMUP_STEPS}_r${NUM_REPEATS}_m${MAX_NEW_TOKENS}
fi
...
for name in \
  ...
  "ps64_topk32_comp2_haar_drop_w${WARMUP_STEPS}_r${NUM_REPEATS}_m${MAX_NEW_TOKENS}" \
  "ps64_topk32_comp4_haar_drop_w${WARMUP_STEPS}_r${NUM_REPEATS}_m${MAX_NEW_TOKENS}"
do
