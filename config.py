...
class DCTPageConfig:
    ...
    num_recent_pages: int = 4      # Number of full recent pages always attended; EXCLUDES the currently-open partial page (open is implicit, +1). Total recent slots = num_recent_pages + 1.
    compress_ratio: float = 0.125   # Per-page compression (32 -> 4 token)
