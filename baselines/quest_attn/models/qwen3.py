# Based on HuggingFace Qwen3 Model
# Adapted from quest_attn/models/llama.py for Qwen3 architecture

"""Quest attention integration for Qwen3 models."""
import math
...
from quest_attn.models.QuestAttention import QuestAttention
from quest_attn.utils.controller import InferenceController
...
class Qwen3DecoderLayer(nn.Module):
    ...
    def forward(
        ...
        torch.cuda.nvtx.range_push("Qwen3Attention")
...
class Qwen3PreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        # Delegate to the base class which respects `_is_hf_initialized`.
...
class Qwen3ForCausalLM(Qwen3PreTrainedModel, GenerationMixin):
    ...
    def quest_clear(self):
        """
        Clean states of KV-Cache for a new conversation.
        """
    ...
    def forward(
        ...
        torch.cuda.nvtx.range_push("Qwen3ForCausalLM")
        outputs = self.model(
            input_ids=input_ids,
            attention_mask=attention_mask,
            position_ids=position_ids,
